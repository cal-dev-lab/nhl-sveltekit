<script>
    import ImageLeftTextRight from "../../Components/ImageLeftTextRight.svelte";
    import FromLeft from "../../Components/ScrollAnimations/FromLeft.svelte";
</script>
...
<section>
    <FromLeft>
        <ImageLeftTextRight 
            image="watering" 
            title="When to water your house plant"
